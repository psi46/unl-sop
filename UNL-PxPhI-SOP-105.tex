...
\begin{figure}[h]
    \begin{center}
        \includegraphics[scale= 0.3, angle=-180]{img/potting_materials.pdf}
        \caption{Material to prepare Sylgard. TODO: explain parts shown on image.}
...
\begin{figure}[h]
    \begin{center}
        ...
        \caption{Gantry setup. The gantry is used for glueing too (SOP-103). For encapsulation, the relevant parts are the gantry head, the vision system, the syringe holder, the cameras for syringe calibration and the BBM chucks.}
